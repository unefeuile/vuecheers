...
""" *************************************************************
	...
	★次の環境で動作を確認しています。
	　Windows7 64bit - Python 3.4.3
	　Ubuntu12.04 LTS 32bit - Python 3.2.3
	★呼び出し方
	　ローカルのPCからコマンドプロンプトやターミナルから実行してください。
	　python aitalk_webapi_sample.py
	★処理内容
	　- WebAPIに文字列を投げて合成
...
def main():
	...
	# (1) 合成内容設定
	target_text = 'すーいすーいすいすいすい、たかひろが飲まなきゃ嫌だっちゃ！！！！'
	target_file = 'output2.mp3'	# mp3, ogg, m4a, wav いずれかのファイルパス
